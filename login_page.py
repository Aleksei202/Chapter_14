...
class LoginPage:
    def __init__(self, browser):
        ...
        self.email_sent_text = Element(browser, By.XPATH, "//*[@class='alert alert-success']")#AN code chapter 14.3
    ...
    def verify_email_sent_text(self):#AN code chapter 14.3
        self.email_sent_text.wait_until_visible()
